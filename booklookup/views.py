...
def search_results(request):
    ...
    if request.method == "POST":
        ...
        api_books = requests.get("https://kiosk-api-git-main-team6-walle.vercel.app/Books/?book_name=", keyword_to_search.strip())
        api_borrows = requests.get("https://kiosk-api-git-main-team6-walle.vercel.app/Borrow/", keyword_to_search.strip())
